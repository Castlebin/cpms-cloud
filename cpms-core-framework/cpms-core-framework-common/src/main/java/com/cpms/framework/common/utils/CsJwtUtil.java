...
public class CsJwtUtil {
    private static final String APPLICATION_NAME = "Cpms";
    /**有效期默认2两小时，单位：毫秒**/
    private static final long TOKEN_EXPIRE = 3600*2*1000;
    private static final String BASE64_SECURITY = Base64.getEncoder().encodeToString(APPLICATION_NAME.getBytes(Charsets.UTF_8));
    /**指定签名的时候使用的签名算法**/
