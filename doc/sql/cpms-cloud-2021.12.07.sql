...
CREATE TABLE `cpms_system_role_user` (
  ...
  KEY `user_id` (`user_id`),
  KEY `role_id` (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1468194468493541378 DEFAULT CHARSET=utf8 COMMENT='系统角色用户关系表';

/*Data for the table `cpms_system_role_user` */

insert  into `cpms_system_role_user`(`role_user_id`,`user_id`,`role_id`) values (1464172420088307713,1437695137926684674,1464156988723798018),(1468194468493541377,1464172420088307713,1464171409403650049);
...
insert  into `cpms_system_user`(`user_id`,`tenant_id`,`dept_id`,`post_id`,`user_account`,`user_password`,`user_name`,`user_real_name`,`user_status`,`user_avatar`,`user_sex`,`user_birthday`,`user_mobile`,`sys_data`,`del_flag`,`user_login_ip`,`last_login_time`,`create_time`,`update_time`,`create_by`,`update_by`) values (1437695137926684674,1442414898631729154,1442414898812084225,1450767760723918849,'CS888888','$2a$10$2sQ90igwAqQhEiigMhEjwe4NN8ASSVuEAGRMbbA4GLY1OCZq2nHKG','superAdmin','cpms',0,'https://iconfont.alicdn.com/t/9abd4acd-0b67-4b63-9163-205238a6aab4.png',1,'1991-07-03','15811111111',1,0,'127.0.0.1','2021-12-07 20:04:37','2021-06-13 16:15:34','2021-12-07 20:04:36','CS888888','CS888888'),(1464172420088307713,1442414898631729154,1442429609511301122,1464171813491286018,'CS000002','$2a$10$CpcM3X1PsK1j3DBwGNeNMOenk37TiUt2TQb7zYHADOZqCVUQKKJOq','admin','admin',0,NULL,1,'1991-07-03','15811111111',0,0,'127.0.0.1','2021-11-28 19:52:53','2021-11-26 18:01:23','2021-12-07 20:23:34','CS888888','CS888888');
