...
CREATE TABLE `cpms_system_dept` (
  ...
  `del_flag` tinyint(3) NOT NULL DEFAULT '0' COMMENT '0-正常，1-删除',
  `parent_id` int(11) DEFAULT NULL COMMENT '树形结构，父节点id',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_by` bigint(64) NOT NULL COMMENT '创建人',
  `update_by` bigint(64) NOT NULL COMMENT '更新人',
  PRIMARY KEY (`dept_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='租户部门关系表';

/*Data for the table `cpms_system_dept` */

insert  into `cpms_system_dept`(`dept_id`,`tenant_id`,`dept_name`,`del_flag`,`parent_id`,`create_time`,`update_time`,`create_by`,`update_by`) values 
(1,1,'系统服务总部',0,0,'2021-06-13 16:13:50','2021-06-13 16:15:49',1,1),
(2,1,'研发部',0,1,'2021-06-13 16:13:50','2021-06-13 16:15:52',1,1),
...
CREATE TABLE `cpms_system_log` (
  ...
  `del_flag` tinyint(3) NOT NULL DEFAULT '0' COMMENT '0-正常，1-删除',
  `create_by` bigint(64) DEFAULT NULL COMMENT '操作人',
...
CREATE TABLE `cpms_system_menu` (
  ...
  `update_by` bigint(64) DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`menu_id`)
...
insert  into `cpms_system_role`(`role_id`,`role_name`,`role_code`,`tenant_id`,`role_desc`,`del_flag`,`create_time`,`update_time`,`create_by`,`update_by`) values 
(1,'系统超级管理员','SUPER_ADMINISTRATOR',1,NULL,0,'2021-06-13 16:08:23','2021-06-13 16:20:45',1,1),
(2,'总经理',NULL,2,NULL,0,'2021-06-13 16:08:23','2021-06-13 16:08:49',1,1);
...
insert  into `cpms_system_tenant`(`tenant_id`,`tenant_name`,`del_flag`,`create_time`,`update_time`,`create_by`,`update_by`) values 
(1,'系统服务总部',0,'2021-06-13 16:11:43','2021-06-13 16:12:04',1,1),
(2,'深圳梦想科技有限公司',0,'2021-06-13 16:11:43','2021-06-13 16:12:07',1,1);
...
CREATE TABLE `cpms_system_user` (
  ...
  `tenant_id` bigint(64) NOT NULL COMMENT '所属租户ID',
  `dept_id` bigint(64) DEFAULT NULL COMMENT '所属部门ID',
...
insert  into `cpms_system_user`(`user_id`,`tenant_id`,`dept_id`,`user_name`,`user_password`,`del_flag`,`user_login_ip`,`last_login_time`,`create_time`,`update_time`,`create_by`,`update_by`) values 
(1,1,2,'superAdmin','123456',0,'127.0.0.1','2020-05-17 14:27:19','2021-06-13 16:15:34','2021-06-13 16:16:01',1,1),
(2,2,3,'Mr.Liu','123456',0,'127.0.0.1','2020-05-15 14:27:50','2021-06-13 16:15:34','2021-06-13 16:16:05',1,1);
